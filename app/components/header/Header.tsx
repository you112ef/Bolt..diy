  ...
  return (
    <header
      className={classNames(
        'flex items-center px-3 border-b h-[var(--header-height)]',
        {
          // Adjusted padding
    ...
    >
      <div className="flex items-center gap-2 z-logo text-bolt-elements-textPrimary cursor-pointer">
        ...
        >
          ...
          <img
            src="https://d.top4top.io/p_3448rqs6n1.png"
            alt="logo"
            className="w-[80px] inline-block dark:hidden"
          />
          <img
            src="https://d.top4top.io/p_3448rqs6n1.png"
            alt="logo"
            className="w-[80px] inline-block hidden dark:block"
          />
        </a>
      </div>
