...
export const TAB_ICONS: Record<TabType, string> = {
  ...
  'aiCustomization': 'i-ph:brain-fill', // New Icon
...
export const TAB_LABELS: Record<TabType, string> = {
  ...
  'aiCustomization': 'AI Behavior', // New Label
...
export const TAB_DESCRIPTIONS: Record<TabType, string> = {
  ...
  'aiCustomization': 'Customize the AI model behavior with a custom prompt.', // New Description
...
export const DEFAULT_TAB_CONFIG = [
  ...
  { id: 'aiCustomization', visible: true, window: 'user' as const, order: 4 }, // New
  ...
  { id: 'aiCustomization', visible: true, window: 'developer' as const, order: 4 }, // New
