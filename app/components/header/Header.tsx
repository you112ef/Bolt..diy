    ...
    >
      <div className="flex items-center gap-1.5 z-logo text-bolt-elements-textPrimary cursor-pointer">
        ...
        <a href="/" className="text-xl font-semibold text-accent flex items-center">
          ...
          <img src="/logo-light-styled.png" alt="logo" className="w-[75px] inline-block dark:hidden" />
          <img src="/logo-dark-styled.png" alt="logo" className="w-[75px] inline-block hidden dark:block" />
        </a>
      </div>
      {chat.started && ( // Display ChatDescription and HeaderActionButtons only when the chat has started.
        <>
          <span className="flex-1 px-3 truncate text-center text-bolt-elements-textPrimary">
