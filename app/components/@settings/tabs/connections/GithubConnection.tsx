  ...
  return (
    ...
    >
      <div className="p-4 space-y-4">
        ...
        {!connection.user && (
          <div className="text-xs text-bolt-elements-textSecondary bg-bolt-elements-background-depth-1 dark:bg-bolt-elements-background-depth-1 p-2 rounded-lg mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          <div>
            <label className="block text-sm text-bolt-elements-textSecondary dark:text-bolt-elements-textSecondary mb-1.5">
              Token Type
            </label>
            <select
              ...
              className={classNames(
                'w-full px-2 py-1.5 rounded-md text-sm', // Adjusted select padding & rounding
          ...
          <div>
            ...
            <input
              ...
              className={classNames(
                'w-full px-2 py-1.5 rounded-md text-sm', // Adjusted input padding & rounding
        ...
        <div className="flex items-center justify-between">
          {!connection.user ? (
            <button
              ...
              className={classNames(
                'px-3 py-1.5 rounded-md text-sm flex items-center gap-2', // Adjusted button
        ...
        {connection.user && connection.stats && (
          <div className="mt-4 border-t border-bolt-elements-borderColor dark:border-bolt-elements-borderColor pt-4">
            <div className="flex items-center gap-3 p-3 bg-bolt-elements-background-depth-1 dark:bg-bolt-elements-background-depth-1 rounded-lg mb-4">
              <img
            ...
            <Collapsible open={isStatsExpanded} onOpenChange={setIsStatsExpanded}>
              ...
              <CollapsibleContent className="overflow-hidden">
                <div className="space-y-4 mt-4">
                  {/* Languages Section */}
                  <div className="mb-4">
                    <h4 className="text-sm font-medium text-bolt-elements-textPrimary mb-2">Top Languages</h4>
                    <div className="flex flex-wrap gap-2">
                      {Object.entries(connection.stats.languages)
                        ...
                        .map(([language]) => (
                          <span
                            key={language}
                            className="px-2 py-0.5 text-xs rounded-full bg-bolt-elements-sidebar-buttonBackgroundDefault text-bolt-elements-sidebar-buttonText" // Adjusted padding
                          >
                            {language}
                          </span>
                        ))}
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 mb-4">
                    {[
                      ...
                      <div
                        key={index}
                        className="flex flex-col p-2 rounded-lg bg-bolt-elements-background-depth-2 dark:bg-bolt-elements-background-depth-2 border border-bolt-elements-borderColor dark:border-bolt-elements-borderColor" // Adjusted padding
                      >
                        <span className="text-xs text-bolt-elements-textSecondary">{stat.label}</span>
                        <span className="text-base font-medium text-bolt-elements-textPrimary">{stat.value}</span>
                      </div>
                    ))}
                  </div>
                      ...
                      <div>
                        ...
                        <div className="grid grid-cols-3 gap-2">
                          {[
                            ...
                            >
                              <span className="text-xs text-bolt-elements-textSecondary">{stat.label}</span>
                              <span className="text-base font-medium text-bolt-elements-textPrimary flex items-center gap-1">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                      {connection.stats.repos.map((repo) => (
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="group block p-3 rounded-lg bg-bolt-elements-background-depth-1 dark:bg-bolt-elements-background-depth-1 border border-bolt-elements-borderColor dark:border-bolt-elements-borderColor hover:border-bolt-elements-borderColorActive dark:hover:border-bolt-elements-borderColorActive transition-all duration-200" // Adjusted padding
                        >
